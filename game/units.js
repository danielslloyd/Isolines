 ...
 *
 * speed  px/s          range  0 = melee, else px
...
(function () {
    ...
    F.UNIT_TYPES = {
        // --- Bronze Age -----------------------------------------------------
        raider: {
            name: 'Raider', era: 'bronze', hp: 34, speed: 34, dmg: 5, rate: 0.9,
            range: 0, wallMult: 0.3, radius: 3.4, bounty: 6, color: '#c46a3a',
            desc: 'Fast, lightly armed. Swarms weak points and burns houses.'
        },
        spearman: {
            name: 'Spearman', era: 'bronze', hp: 62, speed: 26, dmg: 9, rate: 1.0,
            range: 0, wallMult: 0.7, radius: 3.8, bounty: 9, color: '#a8542e',
            desc: 'Bronze-tipped spears. Steady wall-breakers in numbers.'
        },
        slinger: {
            name: 'Slinger', era: 'bronze', hp: 30, speed: 30, dmg: 8, rate: 1.4,
            range: 70, wallMult: 0.15, radius: 3.2, bounty: 8, color: '#d8964a',
            special: 'ranged',
            desc: 'Pelts your towers from range. Kill them before they whittle defenses.'
        },
        chieftain: {
            name: 'War Chieftain', era: 'bronze', hp: 420, speed: 22, dmg: 26, rate: 1.1,
            range: 0, wallMult: 1.2, radius: 6, bounty: 60, color: '#8c2f18',
            special: 'boss',
            desc: 'Bronze Age warlord. Hits walls hard and soaks arrows.'
        },
        // --- Iron Age --------------------------------------------------------
        swordsman: {
            name: 'Swordsman', era: 'iron', hp: 95, speed: 28, dmg: 13, rate: 0.85,
            range: 0, wallMult: 0.7, radius: 3.8, bounty: 12, color: '#7c8894',
            desc: 'Iron blades and shields. The backbone of the assault.'
        },
        archer: {
            name: 'Archer', era: 'iron', hp: 48, speed: 30, dmg: 12, rate: 1.2,
            range: 95, wallMult: 0.1, radius: 3.2, bounty: 12, color: '#5c7a4a',
            special: 'ranged',
            desc: 'Outranges watchtowers. Screens the assault troops.'
        },
        ram: {
            name: 'Battering Ram', era: 'iron', hp: 520, speed: 13, dmg: 65, rate: 1.6,
            range: 0, wallMult: 6, radius: 7, bounty: 45, color: '#6a4a26',
            special: 'ram',
            desc: 'Crawls to your gate and smashes through. Weak to dropped oil.'
        },
        shieldbearer: {
            name: 'Shieldbearer', era: 'iron', hp: 210, speed: 22, dmg: 8, rate: 1.1,
            range: 0, wallMult: 0.5, radius: 4.4, bounty: 18, color: '#4a5a6a',
            desc: 'Heavy shields absorb tower fire while others climb.'
        },
        // --- Medieval ---------------------------------------------------------
        knight: {
            name: 'Knight', era: 'medieval', hp: 300, speed: 40, dmg: 22, rate: 0.8,
            range: 0, wallMult: 0.6, radius: 4.6, bounty: 30, color: '#3c4c74',
            desc: 'Fast, armored cavalry. Punishes any breach instantly.'
        },
        crossbowman: {
            name: 'Crossbowman', era: 'medieval', hp: 70, speed: 26, dmg: 26, rate: 1.6,
            range: 110, wallMult: 0.1, radius: 3.4, bounty: 18, color: '#2e5a3e',
            special: 'ranged',
            desc: 'Armor-piercing bolts shred towers and oil crews.'
        },
        sapper: {
            name: 'Sapper', era: 'medieval', hp: 85, speed: 38, dmg: 4, rate: 1,
            range: 0, wallMult: 1, radius: 3.4, bounty: 25, color: '#6a6a3a',
            special: 'sapper',
            desc: 'Sprints to the wall and sets a charge: 280 damage in a blast.'
        },
        catapult: {
            name: 'Catapult', era: 'medieval', hp: 380, speed: 11, dmg: 70, rate: 4.0,
            range: 135, wallMult: 1, radius: 7, bounty: 55, color: '#5a4632',
            special: 'artillery',
            desc: 'Lobs stones at walls and towers from range.'
        },
        siegetower: {
            name: 'Siege Tower', era: 'medieval', hp: 700, speed: 10, dmg: 0, rate: 2.0,
            range: 0, wallMult: 0, radius: 8, bounty: 70, color: '#7a6248',
            special: 'siegetower',
            desc: 'Docks against your wall and pours swordsmen over the top.'
        },
        trebuchet: {
            name: 'Trebuchet', era: 'medieval', hp: 450, speed: 8, dmg: 130, rate: 6.0,
            range: 170, wallMult: 1, radius: 8, bounty: 90, color: '#4a3a28',
            special: 'artillery',
            desc: 'Massive range. Counter it with ballistae on high ground.'
        },
        warlord: {
            name: 'Warlord', era: 'medieval', hp: 1500, speed: 20, dmg: 45, rate: 0.9,
            range: 0, wallMult: 1.5, radius: 7, bounty: 250, color: '#241c3c',
            special: 'boss',
    ...
    class Projectile {
        ...
        arcOffset() {
            ...
            return Math.sin(Math.PI * k) * Math.min(46, d * 0.3);
        }
    }
